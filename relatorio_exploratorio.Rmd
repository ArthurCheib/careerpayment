...
eppggs_dataset %>%
  ...
  geom_text(aes(10, mean_line,label = "Média de graduados \n por turma = 23", vjust = 3, hjust = -0.1)) +
  theme(legend.position = "none",
...
Análise salarial por csap entre homens e mulheres (gráfico do Felipe Flore: meio a meio)
```{r}
